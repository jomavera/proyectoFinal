...
class Evento(db.Model):
    ...
    categoria_id = db.Column(db.Integer, db.ForeignKey('categorias.id'), unique=False, nullable=False)
    locacion_id = db.Column(db.Integer, db.ForeignKey('locaciones.id'), unique=False, nullable=False)
    ...
    def __init__(self, name, categoria_id, locacion_id, descripcion, sinopsis, precio, duracion, imagen):
        self.name = name
...
class Ticket(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    funcion_id = db.Column(db.Integer, db.ForeignKey('funciones.id'), unique=False, nullable=False)
...
class Funcion(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    evento_id = db.Column(db.Integer, db.ForeignKey('eventos.id'), unique=False, nullable=False )
...
class Orden(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    usuario_id = db.Column(db.Integer, db.ForeignKey('users.id'), unique=False, nullable=False)
    funcion_id = db.Column(db.Integer, db.ForeignKey('funciones.id'), unique=False, nullable=False)

    def __init__(self, usuario_id, funcion_id):
...
class Compra(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    ticket_id = db.Column(db.Integer, db.ForeignKey('tickets.id'), unique=False, nullable=False)
    orden_id = db.Column(db.Integer, db.ForeignKey('ordenes.id'), unique=False, nullable=False)

    def __init__(self, ticket_id, orden_id):
