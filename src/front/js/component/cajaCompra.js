...
export const CajaCompra = (props) => {
  ...
  async function obtenerDatosFunciones(evento_id) {
    const response = await fetch(
      `https://3001-jomavera-proyectofinal-kaws94oob0w.ws-us38.gitpod.io/api/funciones/${evento_id}`,
      {
        method: "GET",
        headers: {
  ...
  async function obtenerDatosHorasFuncion(evento_id, fecha) {
    const response = await fetch(
      `https://3001-jomavera-proyectofinal-kaws94oob0w.ws-us38.gitpod.io/api/horas/${evento_id}/${fecha}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
